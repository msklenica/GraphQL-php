                ...
                [
                    'queries'            => [
                        new Query('query', null,
                            [
                                new Argument('teas', new VariableReference('variable', location: new Location(1, 39), variable: (new Variable('variable', 'Int', false, false, true, new Location(1, 8)))->setUsed(true)), new Location(1, 33)),
                            ],
                            [
